...
let handler = async function (m, { text, usedPrefix }) {
  ...
  let pantek = 'https://telegra.ph/file/DexBot2'
  ...
  if (age > 21) throw 'Maaf, Anda terlalu tua.'
  user.name = name
