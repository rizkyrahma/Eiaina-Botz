...
"headerType": "DOCUMENT", "documentMessage": {
  ...
  }}, 'buttonsMessage', { quoted: false, contextInfo: { mentionedJid: [user], forwardingScore: 999, isForwarded: true, externalAdReply: { title: wm, body: 'ElainaBot', description: ' Recode By Adryanz', mediaType: 2, thumbnail: img, mediaUrl: `https://youtu.be/Hp8Kw4--OyQ`}}})
            }
          }
        }
        break
...
Fitur ini tidak dapat bekerja dengan baik jika bot tidak menjadi admin`,
    unreg: `*_Anda Belum Ada Didalam Database Bot!_*

Hai @${m.sender.split`@`[0]}

Silahkan daftar terlebih dahulu untuk menggunakan bot ini.
pastikan data yang di isi valid, guna agar dapat menyimpan Data anda!
